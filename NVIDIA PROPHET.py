...
# Download data
gs = yf.download("NVDA", start="2013-10-01", end="2024-10-30")
...
# Split the data
train_prophet = prophet_data[prophet_data['ds'] <= '2024-05-30']
test_prophet = prophet_data[prophet_data['ds'] > '2024-05-30']
